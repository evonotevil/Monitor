...
6. **每周一自动发布周报**，生成可在手机和电脑上查看的 HTML 报告页面（也可手动触发）
...
### 每周（每周一北京时间 10:10 自动触发）

每周一上午 10:10（北京时间）系统会自动发布周报。团队也可在完成多维表格初筛后，在 GitHub 上手动触发「发布周报」提前发出。系统会：
...
| 地区 | 涵盖国家 | 代表监管来源 |
|------|----------|-------------|
| 🌎 北美 | 美国、加拿大、墨西哥及中美洲/加勒比海 23 国 | FTC、联邦公报、纽约州 AG、加拿大竞争局 |
| 🌍 欧洲 | 欧盟成员国、英国、挪威、瑞士、俄罗斯等全欧 45 国 | GDPR 执法动态、Ofcom、ICO、CNIL、PEGI |
...
**Q：周报是自动发送的吗？**
A：是。系统每周一北京时间 10:10 自动触发发布。如果团队希望提前发出（例如初筛已完成），也可以在 GitHub Actions 页面手动点击「Run workflow」。
...
系统每周一北京时间 10:10 自动运行。如需提前手动触发：进入 GitHub 仓库 → Actions → 「发布周报」→ Run workflow。
