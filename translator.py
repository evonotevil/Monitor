...
_AI_SYSTEM = """你是全球游戏合规高级分析师，专注于 Hoyoverse、Lilith Games、鹰角等中资游戏公司的出海合规监控。
...
【任务二：地区识别（region）】
从文章内容判断最相关地区，从以下选一个：
欧盟 英国 德国 法国 荷兰 比利时 奥地利 意大利 西班牙 波兰 瑞典 挪威 俄罗斯 乌克兰
美国 加拿大 墨西哥
越南 印度尼西亚 泰国 菲律宾 马来西亚 新加坡 缅甸 柬埔寨 老挝 文莱
台湾 日本 韩国
香港 澳门
印度 巴基斯坦 孟加拉国 斯里兰卡 澳大利亚 新西兰
巴西 阿根廷 智利 哥伦比亚
沙特 阿联酋 土耳其 以色列 尼日利亚 南非
全球 其他
...
_VALID_REGIONS = {
    ...
    "北美", "美国", "加拿大", "墨西哥",
    # 欧洲
    "欧洲", "欧盟", "英国", "德国", "法国", "荷兰", "比利时", "奥地利", "意大利",
    "西班牙", "葡萄牙", "波兰", "瑞典", "挪威", "芬兰", "丹麦", "冰岛",
    "爱尔兰", "瑞士", "捷克", "匈牙利", "罗马尼亚", "希腊", "塞浦路斯",
    "俄罗斯", "乌克兰", "白俄罗斯",
    # 日韩台
    "日本", "韩国", "台湾",
    # 港澳
    "香港", "澳门", "港澳", "港澳台",
    # 东南亚
    "东南亚", "越南", "泰国", "印度尼西亚", "菲律宾", "马来西亚", "新加坡",
    "缅甸", "柬埔寨", "老挝", "文莱",
    # 其他
    "印度", "巴基斯坦", "孟加拉国", "斯里兰卡", "南亚",
    "澳大利亚", "新西兰", "大洋洲",
    "巴西", "阿根廷", "智利", "哥伦比亚", "秘鲁", "南美",
    "沙特", "沙特阿拉伯", "阿联酋", "土耳其", "以色列", "伊朗", "中东",
    "尼日利亚", "南非", "埃及", "肯尼亚", "非洲", "中东/非洲",
    "全球", "其他",
}
