...
- "平台政策"适用于：App Store/Google Play 政策变更、IAP 规则、第三方支付强制要求（DMA）、IDFA/GAID 隐私政策
- "PC & 跨平台合规"适用于：PC Launcher 权限、Anti-cheat 程序合规、PC 端 D2C/Top-up、跨平台数据传输
