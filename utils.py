...
#
# 2026-03 变更：南亚从"亚太"拆出为独立分组
# 亚太 = 东南亚 + 大洋洲；南亚 = 印度/巴基斯坦/孟加拉国/斯里兰卡
# 显示顺序：北美 → 欧洲 → 日韩台 → 亚太 → 南亚 → 中东 → 南美 → 其他

_REGION_GROUP_MAP = {
    # 亚太（东南亚 + 大洋洲）
    "东南亚": "亚太", "越南": "亚太", "印度尼西亚": "亚太",
    "泰国": "亚太", "菲律宾": "亚太", "马来西亚": "亚太", "新加坡": "亚太",
    "缅甸": "亚太", "柬埔寨": "亚太", "亚太": "亚太",
    "大洋洲": "亚太", "澳大利亚": "亚太", "新西兰": "亚太",
    # 南亚（独立分组：印度/巴基斯坦/孟加拉国/斯里兰卡）
    "南亚": "南亚", "印度": "南亚", "巴基斯坦": "南亚", "孟加拉国": "南亚", "斯里兰卡": "南亚",
    # 中东
...
_GROUP_ORDER = ["北美", "欧洲", "日韩台", "亚太", "南亚", "中东", "南美", "其他"]
...
def _get_region_group(region: str) -> str:
    """将原始 region 字段值映射到 7 大显示分组，找不到时返回'其他'。"""
